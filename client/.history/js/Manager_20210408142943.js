      ...
      console.log(company);
        ...
        var tmp = "";
            for(let i = 0; i < company.length; i++){
                ...
                tmp        +=    '<td><button style="background: #30C0F0 0% 0% no-repeat padding-box;" id="de>Detail</button><button style="background: #D31212 0% 0% no-repeat padding-box;">Delete</button></td>';
                tmp        +='</tr>';
            }
