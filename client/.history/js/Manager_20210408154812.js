const getCompany = async () => {
  ...
  if (status !== "") {
      ...
      console.log(company);
        ...
        var tmp = "";
            for(let i = 0; i < company.S; i++){
                tmp +='<tr>';
                tmp    +=    '<td>'+company[i].content.code+'</td>';
                tmp        +=    '<td>'+company[i].content.name+'</td>';
                tmp        +=    '<td>'+company[i].content.email+'</td>';
                tmp        +=    '<td>'+company[i].content.phoneNumber+'</td>';
                tmp        +=    '<td id="'+company[i].content.status+'">'+company[i].status+'</td>';
